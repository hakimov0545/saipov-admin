	...
	return (
		<div className="space-y-6">
			<div className="flex justify-between items-center">
				<div>
					...
					<p className="text-muted-foreground">
						Mahsulotlarni boshqaring va yangilarini
						qo'shing
					</p>
				</div>
				<Button
				...
				<Card>
					<CardContent className="flex flex-col items-center justify-center py-12">
						...
						<p className="text-gray-500 text-center mb-4">
							Hozircha mahsulotlar yo'q yoki qidiruv
							natijasida hech narsa topilmadi.
						</p>
						<Button
							onClick={() => {
								setEditingProduct(null);
			...
			<DeleteConfirmDialog
				...
				description={`"${
					deleteProduct?.titleUz || deleteProduct?.title
				}" mahsulotini o'chirishni tasdiqlaysizmi? Bu amalni bekor qilib bo'lmaydi.`}
			/>
		</div>
	);
};
