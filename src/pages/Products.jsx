    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Mahsulotlarni boshqaring va yangilarini qo'shing</p>
        </div>
        <Button
          onClick={() => {
              ...
              <CardContent>
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Sklad: {product.stockQuantity} dona</p>
                  </div>
                  <div className="text-right">
                    {product.sizes?.length > 0 && (
                      <p className="text-sm text-muted-foreground">O'lchamlar: {product.sizes.join(", ")}</p>
                    )}
                    {product.colors?.length > 0 && (
                      <p className="text-sm text-muted-foreground">Ranglar: {product.colors.join(", ")}</p>
                    )}
                  </div>
                </div>
              </CardContent>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 text-center mb-4">
              Hozircha mahsulotlar yo'q yoki qidiruv natijasida hech narsa topilmadi.
            </p>
            <Button
              onClick={() => {
                setEditingProduct(null)
